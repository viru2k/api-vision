...
class ObraSocialController extends ApiController
{
    ...
    {
        $res= DB::table('obra_social','entidad','categoria_iva')
        ->join('entidad', 'entidad.id', '=', 'obra_social.entidad_factura_id')
        ->join('categoria_iva', 'categoria_iva.id', '=', 'entidad.categoria_iva_id')
        ->select(
        'obra_social.id',
        'obra_social.nombre',
        ...
        'entidad.categoria_iva_id',
        'categoria_iva.categoria_iva',
        'entidad.cuit',
        'entidad.direccion',
        'categoria_iva.id as categoria_iva_id'
        )
                 ->get();
