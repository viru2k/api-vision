...
class OperacionCobroController extends ApiController
{
  ...
  public function registroOperacionCobro(Request $request)
  {
    ...
    try {
      ...
      DB::table("operacion_cobro_medico")->insertGetId([
        "operacion_cobro_id" => $id,
        "medico_factura_id" =>
          $request->operacionCobroMedico["medico_factura_id"],
      ...
      if (isset($t_distribucion[0]["id"])) {
        foreach ($t_distribucion as $res) {
          ...
          DB::table("operacion_cobro_distribucion")->insertGetId([
            ...
            "obra_social_practica_nombre" =>
              $res["obra_social_practica_nombre"],
            "operacion_cobro_id" => $id,
            "convenio_os_pmo_id" => $res["convenio_os_pmo_id"],
  ...
  public function updateOperacionCobroValoresByNumeroAfectacion(
    Request $request
  ) {
    ...
    $horario = DB::statement(
      " 
        ...
        obra_social.id = convenio_os_pmo.obra_social_id AND operacion_cobro_practica.liquidacion_numero IN (" .
        $in .
        ")         
    "
    );
  ...
  public function getOperacionCobroRegistrosBetweenDates(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw("SELECT operacion_cobro_practica.id , operacion_cobro.id as operacion_cobro_id, convenio_os_pmo.id as pmo_id,forma_pago, 
  ...
  public function getOperacionCobroRegistrosBetweenDatesAndMedico(
    Request $request
  ) {
  ...
  public function getOperacionCobroRegistrosBypacienteId(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        ...
        operacion_cobro.liquidacion_numero as operacion_cobro_liquidacion_numero, operacion_cobro.estado as operacion_cobro_estado, operacion_cobro_obra_social.nombre as operacion_cobro_obra_social_nombre,
        CONCAT(operacion_cobro_paciente.apellido,' ' , operacion_cobro_paciente.nombre) as  operacion_cobro_paciente_nombre, operacion_cobro_practica.tiene_observacion, operacion_cobro_practica.motivo_observacion,
         operacion_cobro.es_anulado as operacion_cobro_es_anulado, operacion_cobro_practica.es_anulado, internacion_tipo,  IFNULL(liquidacion_distribucion_id, 0) AS liquidacion_distribucion_id
        FROM users as usuario_cobro, obra_social as operacion_cobro_obra_social , paciente as operacion_cobro_paciente,operacion_cobro_practica
        LEFT JOIN operacion_cobro 
        ON  operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id , paciente, convenio_os_pmo, pmo,users, obra_social WHERE operacion_cobro_practica.paciente_id = paciente.id AND operacion_cobro.paciente_id =  operacion_cobro_paciente.id AND  operacion_cobro_practica.convenio_os_pmo_id = convenio_os_pmo.id AND convenio_os_pmo.pmo_id = pmo.id 
        AND operacion_cobro_practica.user_medico_id = users.id AND convenio_os_pmo.obra_social_id = obra_social.id  AND usuario_cobro.id = usuario_realiza_id    AND operacion_cobro_obra_social.id = operacion_cobro.obra_social_id AND operacion_cobro_practica.paciente_id= " .
          $id .
          "
    "
      )
  ...
  public function getOperacionCobroRegistrosBetweenDatesAnulado(
    Request $request
  ) {
    $user_medico_id = $request->input("user_medico_id");
    $tmp_fecha = str_replace("/", "-", $request->input("fecha_desde"));
    ...
    $horario = DB::select(
      DB::raw(
        ...
        FROM users as usuario_cobro, obra_social as operacion_cobro_obra_social , paciente as operacion_cobro_paciente,operacion_cobro_practica
        LEFT JOIN operacion_cobro 
        ON  operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id , paciente, convenio_os_pmo, pmo,users, obra_social WHERE operacion_cobro_practica.paciente_id = paciente.id AND operacion_cobro.paciente_id =  operacion_cobro_paciente.id AND  operacion_cobro_practica.convenio_os_pmo_id = convenio_os_pmo.id AND convenio_os_pmo.pmo_id = pmo.id AND operacion_cobro_practica.user_medico_id = users.id AND convenio_os_pmo.obra_social_id = obra_social.id  AND usuario_cobro.id = usuario_realiza_id  AND estado_facturacion = 'P' AND estado_liquidacion= :estado_liquidacion  AND operacion_cobro_obra_social.id = operacion_cobro.obra_social_id AND operacion_cobro_practica.es_anulado = 'SI' AND operacion_cobro_practica.user_medico_id= " .
          $user_medico_id .
          " AND  operacion_cobro.fecha_cobro BETWEEN :fecha_desde AND :fecha_hasta 
    "
      ),
  ...
  public function getOperacionCobroRegistroDistribucionByIdPrefactura(
    Request $request
  ) {
    $id = $request->input("id");
    $estado_liquidacion = $request->input("estado_liquidacion");
  ...
  public function updateOperacionCobroDistribucionOperacionCobro(
    Request $request,
    $id
  ) {
    //var_dump($request);
  ...
  {
    $tmp_fecha = str_replace(
      "/",
      "-",
      $request->input("operacion_cobro_fecha_cobro")
    );
    $timezone = -3;
    $fecha_cobro = date(
      "Y-m-d H:i:s",
      strtotime($tmp_fecha) + 3600 * ($timezone + date("I"))
    );
    ...
    $update = DB::table("operacion_cobro")
      ...
      ->update([
        ...
        "total_honorarios_medicos" => $request->input(
          "operacion_cobro_total_honorarios_medicos"
        ),
        ...
        "liquidacion_numero" => $request->input(
          "operacion_cobro_liquidacion_numero"
        ),
  ...
  public function afectarOperacionCobro(Request $request)
  {
    ...
    while (isset($request->registros[$i])) {
      $update = DB::table("operacion_cobro_practica")
        ->where("id", $request->registros[$i]["id"])
        ->limit(1)
        ->update([
  ...
  public function generarLiquidacionNumero(Request $request)
  {
    ...
    $resp = DB::select(
      DB::raw(
        " SELECT numero, fecha_liquidacion, estado, created_at, updated_at FROM liq_liquidacion_generada WHERE    id =   " .
          $liquidacion_numero .
          "  
"
      )
...
"
  ...
  public function liquidarOperacionCobro(Request $request)
  {
    ...
    while (isset($request["operacion_cobro_practica"][$i])) {
      ...
      DB::insert(
        "INSERT INTO liq_liquidacion_distribucion( paciente_id, obra_social_id, convenio_os_pmo_id, operacion_cobro_id, medico_id, porcentaje, valor_distribuido, total, fecha_distribucion) VALUES " .
          $distribucion
      );
      $i++;
    }
  ...
  public function getListadoPreFactura(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        "SELECT liq_liquidacion.id as liq_liquidacion_id, liq_liquidacion.obra_social_id, liq_liquidacion.numero, nivel, fecha_desde, fecha_hasta, liquidacion_generada_id, cant_orden, total, usuario_audito, liq_liquidacion.estado as liq_liquidacion_estado,  liq_liquidacion.medico_id as liquidacion_medico_id,
         ...
         WHERE liq_liquidacion.id = operacion_cobro_practica.liquidacion_numero AND operacion_cobro_practica.convenio_os_pmo_id = convenio_os_pmo.id AND
          ...
          operacion_cobro_practica.user_medico_id = users_practica.id AND users.id = medicos.usuario_id AND obra_social.entidad_factura_id = entidad.id AND liq_liquidacion.id  IN (" .
          $in .
          ")  ORDER BY  nivel ASC,matricula ASC, operacion_cobro.fecha_cobro ASC"
      )
    ); //nivel-(1,2)  fecha cobro -oc
    $t = $request->desde;
    return response()->json($horario, 201);
  }
  ...
  public function getListadoPreFacturaCirugia(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        "  SELECT  operacion_cobro_practica.id as operacion_cobro_practica_id, liq_liquidacion.id as liq_liquidacion_id, liq_liquidacion.obra_social_id, liq_liquidacion.numero, nivel, fecha_desde, fecha_hasta, liquidacion_generada_id, cant_orden, operacion_cobro_distribucion.total, usuario_audito, liq_liquidacion.estado as liq_liquidacion_estado, 
  ...
  FROM operacion_cobro ,liq_liquidacion, obra_social,convenio_os_pmo, pmo, users, users as users_practica, paciente, entidad , medicos,(SELECT*  FROM  operacion_cobro_practica where operacion_cobro_practica.liquidacion_numero IN (" .
          $in .
          ")  )  AS operacion_cobro_practica   LEFT JOIN 
   ...
   operacion_cobro_practica.user_medico_id = users_practica.id AND users.id = medicos.usuario_id AND obra_social.entidad_factura_id = entidad.id   AND   obra_social.id = " .
          $request[0]["obra_social_id"] .
          "  AND liq_liquidacion.id IN (" .
          $in .
          ")  ORDER BY nivel ASC, matricula ASC,  operacion_cobro_practica.id, operacion_cobro.fecha_cobro     ASC"
      )
    ); //nivel-(1,2)  fecha cobro -oc
    return response()->json($horario, 201);
  }
  ...
  public function getLiquidacionDetalle(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        " SELECT liq_liquidacion.id, obra_social_id, numero, nivel, fecha_desde, fecha_hasta, liquidacion_generada_id,
        ...
        WHERE liq_liquidacion.obra_social_id = obra_social.id AND usuario_audito = users.id AND categoria_iva.id = entidad.categoria_iva_id AND   obra_social.entidad_factura_id = entidad.id  AND  liq_liquidacion.medico_id = users_medico.id  AND estado ='" .
          $estado .
          "'   order by    id DESC
  ...
  public function getPresentacionDetalleById(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        ...
        FROM users as usuario_cobro, obra_social as operacion_cobro_obra_social , paciente as operacion_cobro_paciente,operacion_cobro_practica
        LEFT JOIN operacion_cobro 
        ON  operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id , paciente, convenio_os_pmo, pmo,users, obra_social WHERE operacion_cobro_practica.paciente_id = paciente.id AND operacion_cobro.paciente_id =  operacion_cobro_paciente.id AND  operacion_cobro_practica.convenio_os_pmo_id = convenio_os_pmo.id AND convenio_os_pmo.pmo_id = pmo.id AND operacion_cobro_practica.user_medico_id = users.id AND convenio_os_pmo.obra_social_id = obra_social.id  AND usuario_cobro.id = usuario_realiza_id  AND estado_facturacion = 'P'  AND operacion_cobro_obra_social.id = operacion_cobro.obra_social_id   AND  operacion_cobro_practica.liquidacion_numero =   " .
          $id .
          "  
    "
      )
  ...
  public function getPresentacionDetalleByMultipleId(Request $request)
  {
    ...
    $resp = DB::select(
      DB::raw(
        ...
        FROM users as usuario_cobro, obra_social as operacion_cobro_obra_social , paciente as operacion_cobro_paciente,operacion_cobro_practica
        LEFT JOIN operacion_cobro 
        ON  operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id , paciente, convenio_os_pmo, pmo,users, obra_social WHERE operacion_cobro_practica.paciente_id = paciente.id AND operacion_cobro.paciente_id =  operacion_cobro_paciente.id AND  operacion_cobro_practica.convenio_os_pmo_id = convenio_os_pmo.id AND convenio_os_pmo.pmo_id = pmo.id AND operacion_cobro_practica.user_medico_id = users.id AND convenio_os_pmo.obra_social_id = obra_social.id  AND usuario_cobro.id = usuario_realiza_id  AND estado_facturacion = 'P'  AND operacion_cobro_obra_social.id = operacion_cobro.obra_social_id   AND  operacion_cobro_practica.liquidacion_numero IN (" .
          $in .
          ") 
    "
      )
  ...
  public function desafectarPresentacion(Request $request)
  {
    ...
    $estado = DB::update(
      DB::raw(
        "
       UPDATE operacion_cobro_practica, operacion_cobro SET operacion_cobro_practica.estado_liquidacion = 'AUD',  operacion_cobro.liquidacion_numero = 0, operacion_cobro_practica.liquidacion_numero = 0 WHERE operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id AND operacion_cobro_practica.estado_liquidacion = 'AFE' AND operacion_cobro.fecha_cobro  AND operacion_cobro_practica.liquidacion_numero= " .
          $liquidacion_nro .
          "
    "
      )
    ...
    DB::table("liq_liquidacion")
      ->where("id", "=", $liquidacion_nro)
      ->delete();
  ...
  public function updateValoresDistribucionBetwenDates(Request $request)
  {
    ...
    $horario = DB::statement(
      " UPDATE operacion_cobro_distribucion, practica_distribucion, operacion_cobro, operacion_cobro_practica 
  ...
  WHERE operacion_cobro_distribucion.practica_distribucion_id = practica_distribucion.id   AND operacion_cobro_distribucion.operacion_cobro_id = operacion_cobro.id AND operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id AND  operacion_cobro_practica.estado_liquidacion != 'DIS' AND operacion_cobro.fecha_cobro BETWEEN '" .
        $fecha_desde .
        "' AND '" .
        $fecha_hasta .
        "'
"
  ...
  public function GetDistribucionByExpediente(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        ...
        LEFT OUTER JOIN users as medico_clinica  ON medico_clinica.id = liq_liquidacion_distribucion.medico_clinica_id WHERE liq_liquidacion_distribucion.id = operacion_cobro_practica.liquidacion_distribucion_id AND operacion_cobro_practica.liquidacion_numero IN ('" .
          $in .
          "') AND operacion_cobro_practica.es_distribuido = 'SI'
    "
      )
    );
  ...
  public function GetDistribucionByMedico(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        "SELECT obra_social.nombre as obra_social_nombre, obra_social.id as obra_social_id,  liq_liquidacion_distribucion.id, medico_opera_id, medico_opera.nombreyapellido as medico_opera,   medico_opera_porcentaje, medico_opera_valor, medico_ayuda_id,medico_ayuda.nombreyapellido as medico_ayuda, medico_ayuda_porcentaje, medico_ayuda_valor, medico_ayuda2_id,medico_ayuda2.nombreyapellido as medico_ayuda2, medico_ayuda2_porcentaje, medico_ayuda2_valor, medico_clinica_id,medico_clinica.nombreyapellido as medico_clinica, medico_clinica_porcentaje, medico_clinica_valor, valor_distribuido, total, fecha_liquidacion, usuario_audito, fecha_distribucion, concepto_liquidacion_id,operacion_cobro_practica.operacion_cobro_id,operacion_cobro.fecha_cobro ,CONCAT(paciente.apellido,' ' , paciente.nombre) as paciente_apellido, paciente.dni FROM paciente, operacion_cobro_practica, operacion_cobro ,obra_social, convenio_os_pmo, liq_liquidacion_distribucion 
        LEFT OUTER JOIN users as medico_ayuda  ON medico_ayuda.id = liq_liquidacion_distribucion.medico_ayuda_id
        LEFT OUTER JOIN users as medico_ayuda2  ON medico_ayuda2.id = liq_liquidacion_distribucion.medico_ayuda2_id
        LEFT OUTER JOIN users as medico_opera  ON medico_opera.id = liq_liquidacion_distribucion.medico_opera_id
        LEFT OUTER JOIN users as medico_clinica  ON medico_clinica.id = liq_liquidacion_distribucion.medico_clinica_id  WHERE operacion_cobro_practica.convenio_os_pmo_id = convenio_os_pmo.id AND convenio_os_pmo.obra_social_id = obra_social.id AND liq_liquidacion_distribucion.id = operacion_cobro_practica.liquidacion_distribucion_id AND operacion_cobro_practica.paciente_id = paciente.id AND operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id AND  operacion_cobro_practica.liquidacion_numero IN (" .
          $in .
          ")
  ...
  public function GetDistribucionByMedicoDetalle(Request $request)
  {
    ...
    $horario = DB::select(
      DB::raw(
        " SELECT pmo.descripcion, pmo.codigo, operacion_cobro_practica.id as operacion_cobro_practica_id, obra_social.nombre as obra_social_nombre, obra_social.id as obra_social_id,  liq_liquidacion_distribucion.id, medico_opera_id, medico_opera.nombreyapellido as medico_opera,   medico_opera_porcentaje, medico_opera_valor, medico_ayuda_id,medico_ayuda.nombreyapellido as medico_ayuda, medico_ayuda_porcentaje, medico_ayuda_valor, medico_ayuda2_id,medico_ayuda2.nombreyapellido as medico_ayuda2, medico_ayuda2_porcentaje, medico_ayuda2_valor, medico_clinica_id,medico_clinica.nombreyapellido as medico_clinica, medico_clinica_porcentaje, medico_clinica_valor, valor_distribuido, total, fecha_liquidacion, usuario_audito, fecha_distribucion, concepto_liquidacion_id,operacion_cobro_practica.operacion_cobro_id,operacion_cobro.fecha_cobro ,CONCAT(paciente.apellido,' ' , paciente.nombre) as paciente_apellido, paciente.dni FROM pmo, paciente, operacion_cobro_practica, operacion_cobro ,obra_social, convenio_os_pmo, liq_liquidacion_distribucion 
        LEFT OUTER JOIN users as medico_ayuda  ON medico_ayuda.id = liq_liquidacion_distribucion.medico_ayuda_id
        LEFT OUTER JOIN users as medico_ayuda2  ON medico_ayuda2.id = liq_liquidacion_distribucion.medico_ayuda2_id
        LEFT OUTER JOIN users as medico_opera  ON medico_opera.id = liq_liquidacion_distribucion.medico_opera_id
        LEFT OUTER JOIN users as medico_clinica  ON medico_clinica.id = liq_liquidacion_distribucion.medico_clinica_id  WHERE pmo.id = convenio_os_pmo.pmo_id AND  operacion_cobro_practica.convenio_os_pmo_id = convenio_os_pmo.id AND convenio_os_pmo.obra_social_id = obra_social.id AND liq_liquidacion_distribucion.id = operacion_cobro_practica.liquidacion_distribucion_id AND operacion_cobro_practica.paciente_id = paciente.id AND operacion_cobro_practica.operacion_cobro_id = operacion_cobro.id AND  operacion_cobro_practica.liquidacion_numero IN (" .
          $in .
          ") order BY operacion_cobro.fecha_cobro ASC , operacion_cobro.id, operacion_cobro_practica.id
    "
      )
    );
...
SELECT   obra_social_id, numero, nivel, fecha_desde, fecha_hasta, liquidacion_generada_id, cant_orden, total, medico_id, usuario_audito, estado, created_at, updated_at FROM liq_liquidacion WHERE  id IN (" .
          $in .
          ")"
      )
    );
...
SELECT  convenio_os_pmo_id, valor_original, valor_facturado, coeficiente, forma_pago, operacion_cobro_id, paciente_id, user_medico_id, categorizacion, observacion, created_at, updated_at, usuario_audita_id, " .
          $ultimo[0]->ultimo .
          ", estado_liquidacion, estado_facturacion, facturacion_nro, distribuido, usuario_realiza_id, usuario_modifica_id, usuario_liquida_id, liquidacion_distribucion_id, liquidacion_realizada_numero, es_distribuido, cantidad, tiene_observacion, motivo_observacion, es_anulado, internacion_tipo FROM operacion_cobro_practica where operacion_cobro_practica.liquidacion_numero  IN (" .
          $in .
          ")    "
      )
    );
  ...
  {
    $res = DB::select(
      DB::raw("SELECT id, estudio, estudio_descripcion, estado  FROM `v2-parametro-estudio`
        ")
    );
    return response()->json($res, "200");
  }

  public function getEstudio(Request $request)
  {
    $id = $request->input("id");
    $res = DB::select(
      DB::raw(
        "SELECT id, estudio, estudio_descripcion, estado FROM `v2-parametro-estudio`  WHERE  id = " .
          $id .
          "
        "
      )
  ...
  {
    $id = DB::table("v2-parametro-estudio")->insertGetId([
      "estudio" => $request->estudio,
      "estudio_descripcion" => $request->estudio_descripcion,
    ]);
    return response()->json($id, "200");
  }

  public function putEstudio(Request $request, $id)
  {
    $res = DB::table("v2-parametro-estudio")
      ->where("id", $id)
      ->update([
        "estudio" => $request->input("estudio"),
        "estudio_descripcion" => $request->input("estudio_descripcion"),
      ]);
  ...
  {
    $res = DB::select(
      DB::raw("SELECT id, forma_pago, estado FROM `v2-parametro-metodo-pago`
        ")
    );
    return response()->json($res, "200");
  }
  ...
  public function getMetodoPago(Request $request)
  {
    ...
    $res = DB::select(
      DB::raw(
        "SELECT id, forma_pago, estado FROM `v2-parametro-metodo-pago`  WHERE  id = " .
          $id .
          "
        "
      )
  ...
  public function setMetodoPago(Request $request)
  {
    $id = DB::table("v2-parametro-metodo-pago")->insertGetId([
      "forma_pago" => $request->forma_pago,
      "estado" => $request->estado,
    ]);
    return response()->json($id, "200");
  ...
  {
    $res = DB::table("v2-parametro-metodo-pago")
      ->where("id", $id)
      ->update([
  ...
  {
    $res = DB::select(
      DB::raw("SELECT id, receta, receta_descripcion, estado FROM `v2-parametro-receta` 
        ")
    );
    return response()->json($res, "200");
  }
  ...
  public function getReceta(Request $request)
  {
    ...
    $res = DB::select(
      DB::raw(
        "SELECT id, receta, receta_descripcion, estado FROM `v2-parametro-receta`  WHERE  id = " .
          $id .
          "
        "
      )
  ...
  public function setReceta(Request $request)
  {
    $id = DB::table("v2-parametro-receta")->insertGetId([
      "receta" => $request->receta,
      "receta_descripcion" => $request->receta_descripcion,
      "estado" => "ACTIVO",
    ]);
    return response()->json($id, "200");
  }
  ...
  {
    $res = DB::table("v2-parametro-receta")
      ->where("id", $id)
      ->update([
        "receta" => $request->input("receta"),
        "receta_descripcion" => $request->input("receta_descripcion"),
        "estado" => $request->input("estado"),
      ]);
